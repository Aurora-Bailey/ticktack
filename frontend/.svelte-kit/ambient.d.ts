...
declare module '$env/static/private' {
	...
	export const ZSH_EVALCACHE_DIR: string;
	export const NODE: string;
	export const INIT_CWD: string;
	export const ZSH_COLORIZE_STYLE: string;
	...
	export const EZA_COLORS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MANPATH: string;
		ZSH_EVALCACHE_DIR: string;
		NODE: string;
		INIT_CWD: string;
		ZSH_COLORIZE_STYLE: string;
		TERM: string;
		SHELL: string;
		TMPDIR: string;
